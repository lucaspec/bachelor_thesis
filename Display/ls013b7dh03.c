...
#define delay_us(x) _delay_cycles(16*x)
#define delay_ms(x) _delay_cycles(16000*x)
...
#define SCS_1   P2OUT |= BIT7;
#define SCS_0   P2OUT &= ~BIT7;

#define SI_1   P2OUT |= BIT6;
#define SI_0   P2OUT &= ~BIT6;

#define SCLK_1   P2OUT |= BIT4;
#define SCLK_0   P2OUT &= ~BIT4;

#define LCD_ON   P3OUT |= BIT2;
#define LCD_OFF  P3OUT &= ~BIT2;
